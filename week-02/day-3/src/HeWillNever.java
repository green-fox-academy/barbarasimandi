...
public class HeWillNever {
  public static void main(String... args){
    ...
    for (Integer key : map.keySet()) {
      out = map.get(1) + map.get(12) + map.get(1) + map.get(2) + map.get(11) + map.get(1) + map.get(7) + map.get(11) +map.get(1) + map.get(49) + map.get(1) +  map.get(3) +  map.get(11) + map.get(1) +  map.get(50) +  map.get(11);
    }
